...
(function ($) {
    ...
    $.fn.excelexportjs = function (options) {
        ...
        function Initialize() {
            let type = $settings.dataType.toLowerCase();
        ...
        function ConvertDataStructureToTable() {
            ...
            $($settings.columns).each(function (key, value) {
                if (this.ishidden != true) {
                    result += "<th style='background:#f38a42'";
                    if (this.width != null) {
                        result += " style='background:#f38a42 ; width: " + this.width + "'";
                    }
                    result += ">";
        ...
        function Export(htmltable) {
            ...
            if (isBrowserIE()) {
                ...
                let ctx = {worksheet: $settings.worksheetName, table: htmltable};
        ...
        function isBrowserIE() {
            let msie = !!navigator.userAgent.match(/Trident/g) || !!navigator.userAgent.match(/MSIE/g);
