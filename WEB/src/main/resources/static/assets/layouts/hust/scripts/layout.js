var Layout = function() {
    ...
    var layoutImgPath = 'layouts/hust/img/';

    var layoutCssPath = 'layouts/hust/css/';
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (body.hasClass('page-sidebar-fixed')) {
                ...
                if ((height + headerHeight + footerHeight) <= App.getViewPort().height) {
                    height = App.getViewPort().height - headerHeight - footerHeight - 30;
                }
            }
    ...
    var handleSidebarMenu = function() {
        $('.page-sidebar').on('click', 'li > a', function(e) {
            ...
            if ($(this).next().hasClass('sub-menu') === false || ( $(this).next().hasClass('sub-menu') === true && $(this).next().hasClass('ng-hide') )) {
