...
!function (e, t) {
    ...
    return function (e) {
        ...
        var r = function (e) {
            ...
            }, i = r(n(2)), o = r(n(3)), s = r(n(4)), a = r(n(5)), u = r(n(6)), l = r(n(7)), c = r(n(1)), f = r(n(8)),
            p = r(n(9)), d = r(n(10)), v = r(n(11)), h = r(n(12));
                    ...
                    getOptions: {
                        ...
                        value: function () {
                            var e = this.uploader.isHTML5 ? this.element[0].files : this.element[0],
                                t = this.getOptions(), n = this.getFilters();
        ...
        var r = function (e) {
                ...
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }, s = (r(n(2)), angular.copy), a = angular.extend, u = angular.forEach, l = angular.isObject,
            c = angular.isNumber, f = angular.isDefined, p = angular.isArray, d = angular.element;
                ...
                return i(r, {
                    addToQueue: {
                        value: function (e, t, n) {
                            var r = this, i = this.isArrayLikeObject(e) ? e : [e], o = this._getFilters(n),
                                s = this.queue.length, a = [];
                            u(i, function (e) {
                                var n = new v(e);
                        ...
                        value: function (e) {
                            ...
                            var t = this.getNotUploadedItems().length,
                                n = t ? this.queue.length - t : this.queue.length, r = 100 / this.queue.length,
                                i = (e || 0) * r / 100;
                        ...
                        value: function (e) {
                            ...
                            r.append(e.alias, e._file, e.file.name), n.upload.onprogress = function (n) {
                                ...
                                var r = t._parseHeaders(n.getAllResponseHeaders()),
                                    ...
                                    o = t._isSuccessCode(n.status) ? "Success" : "Error", s = "_on" + o + "Item";
                        ...
                        value: function (e) {
                            var t = this, n = d('<form style="display: none;" />'),
                                r = d('<iframe name="iframeTransport' + Date.now() + '">'), i = e._input;
                            e._form && e._form.replaceWith(i), e._form = n, this._onBeforeUploadItem(e), i.prop("name", e.alias), u(e.formData, function (e) {
                                ...
                                var s = {response: n, status: i, dummy: !0}, a = {},
        ...
        var r = function (e) {
            ...
            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
        }, s = (r(n(2)), angular.copy), a = angular.isElement, u = angular.isString;
        e.exports = function () {
            var e = function () {
                function e(t) {
                    o(this, e);
        ...
        var r = function (e) {
            ...
            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
        }, s = (r(n(2)), angular.copy), a = angular.extend, u = angular.element, l = angular.isElement;
        ...
        var r = function (e) {
            ...
            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
        }, u = (r(n(2)), angular.extend), l = angular.forEach;
        e.exports = function (e) {
            var t = function (e) {
                function t(e) {
                    a(this, t);
